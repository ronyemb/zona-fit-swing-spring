...
public class ZonaFitForma extends JFrame{
    ...
    private void guardarCliente(){
        ...
        var cliente = new Cliente(this.idCliente, nombre, apellidos, membresia);
    ...
    private void cargarClienteSeleccionado(){
        ...
        if(renglon != -1){
            ...
            var apellidos = clientesTabla.getModel().getValueAt(renglon, 2).toString();
            this.apellidoTexto.setText(apellidos);
